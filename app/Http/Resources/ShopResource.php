...
class ShopResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'first_service_id'  => $this->when(isset($this->first_service_id), (int) $this->first_service_id),
            'service_master_id'  => $this->when(isset($this->service_master_id), (int) $this->service_master_id),
            ...
            'property'      => is_object($this->property) ? [
                    ...
                    'accommodates'     => $this->property->accommodates ?? null,
                    'bedrooms'         => $this->property->bedrooms ?? null,
                    'beds'             => $this->property->beds ?? null,
                    'bathrooms'        => $this->property->bathrooms ?? null,
                    'price_per_night'  => $this->property->price_per_night ?? null,
                    'currency'         => $this->property->currency ?? null,
                    'check_in_time'    => $this->property->check_in_time ?? null,
                    'check_out_time'   => $this->property->check_out_time ?? null,
                    'instant_bookable' => (bool)$this->property->instant_bookable ?? false,
