...
use App\Http\Controllers\API\v1\Rest\AmenityController;
...
//    Route::get('/login/{provider}',                   [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'rest'], function () {
        ...
        Route::get('properties/{id}/galleries', [Rest\ShopController::class, 'galleriesByProperty']);

        Route::post('shops/slug/{slug}/galleries', [Rest\ShopController::class, 'uploadGalleryImage']);
    ...
    Route::group(['prefix' => 'dashboard', 'middleware' => ['sanctum.check']], function () {
        ...
        Route::group(['prefix' => 'master', 'middleware' => ['sanctum.check'], 'as' => 'master.'], function () {
            ...
            Route::prefix('service-masters')->group(function () {
                Route::get('{master}/properties', [ServiceMasterController::class, 'propertiesByMaster']);
                Route::put('{master}/properties', [ServiceMasterController::class, 'updateProperty']); // ✅ New
            });
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['sanctum.check', 'role:seller|manager'], 'as' => 'admin.'], function () {
            ...
            Route::delete('service-faqs/delete',            [Admin\ServiceController::class, 'destroy']);
